            ...
            <main className="pt-32">
                ...
                <section className="bg-babu-primary text-white py-20">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                            ...
                            and insights from our expert stylists.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mb-16">
                            <h2 className="text-3xl font-serif font-bold text-babu-primary mb-8">
                                Featured Article
                            </h2>
                                ...
                                <div className="md:flex">
                                    ...
                                    <div className="md:w-1/2 p-8 md:p-12">
                                        ...
                                        <h3 className="text-3xl font-serif font-bold text-babu-primary mb-4">
                                            The Ultimate Guide to Bridal Beauty
                                            Preparation
                                        </h3>
                                        <p className="text-gray-600 mb-6 leading-relaxed">
                                            Planning your wedding beauty
                                            timeline can be overwhelming. Our
                                            comprehensive guide breaks down
                                            everything you need to know about
                                            preparing for your special day, from
                                            skincare routines to final
                                            touch-ups.
                                        </p>
                                        <Link
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                Expert tips from our professional stylists to
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                <div
                                    key={index}
                                    className="bg-babu-primary text-white p-6 rounded-2xl"
                                >
                                    <div className="text-babu-accent-2 text-sm font-semibold mb-2">
                                        {item.category}
                                    </div>
                ...
                <section className="py-20 bg-babu-primary text-white">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-xl text-gray-300 mb-8">
                            Subscribe to our newsletter for the latest beauty
                            tips, trends, and exclusive offers
                        </p>
